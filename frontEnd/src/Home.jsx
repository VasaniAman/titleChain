          ...
          <header>
            <div className="row justify-content-between">
              ...
              <div className="col-6 align-self-center text-right">
               <Link id='loginbtn' to="/login-page" className="text-white lead">Login</Link>
               <Link id='signupbtn' to="/register" className="text-white lead">Sign Up</Link>
              </div>
            </div>
          </header>
...
function Home(){
    ...
    return(
        <div className='homepage'>
        {
            auth?
            <div>
                <h3>You have logged in! Welcome {name}</h3>
                <button className="link-btn3">
                    <Link to="/landing" onClick={handleDelete}>Logout</Link>
                </button>
            </div>
            :
            <div>
                
                <Link to="/landing" className="link-btn3">Login</Link>
            </div>
        }
        </div>
    )
